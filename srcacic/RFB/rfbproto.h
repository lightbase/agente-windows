...
// valores definidos para somente aceitar as conexões do srcaciccli
// valores padrão do uvnc: 3 e 4
#define rfbProtocolMajorVersion 15
#define rfbProtocolMinorVersion 17 // Reserved to UltravNC ! (as well as "6")
